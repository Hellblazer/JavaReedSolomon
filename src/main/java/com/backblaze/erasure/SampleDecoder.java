 ...
 * Command-line program that decodes a file using Reed-Solomon 4+2.
 *
 * The file name given should be the name of the file to decode, say "foo.txt".
 * This program will expected to find "foo.txt.0" through "foo.txt.5", with at
 * most two missing. It will then write "foo.txt.decoded".
 */
